...
@class BAASSGCDAsyncUdpSendPacket;

NSString *const BAASSGCDAsyncUdpSocketException = @"BAASSGCDAsyncUdpSocketException";
NSString *const BAASSGCDAsyncUdpSocketErrorDomain = @"BAASSGCDAsyncUdpSocketErrorDomain";

NSString *const BAASSGCDAsyncUdpSocketQueueName = @"BAASSGCDAsyncUdpSocket";
NSString *const BAASSGCDAsyncUdpSocketThreadName = @"BAASSGCDAsyncUdpSocket-CFStream";

enum BAASSGCDAsyncUdpSocketFlags
{
...
enum BAASSGCDAsyncUdpSocketConfig
{
...
@interface BAASSGCDAsyncUdpSocket ()
{
	...
	BAASSGCDAsyncUdpSocketReceiveFilterBlock receiveFilterBlock;
	dispatch_queue_t receiveFilterQueue;
	BOOL receiveFilterAsync;
	
	BAASSGCDAsyncUdpSocketSendFilterBlock sendFilterBlock;
	...
	BAASSGCDAsyncUdpSendPacket *currentSend;
...
/**
 * The BAASSGCDAsyncUdpSendPacket encompasses the instructions for a single send/write.
**/
@interface BAASSGCDAsyncUdpSendPacket : NSObject {
@public
	NSData *buffer;
...
@implementation BAASSGCDAsyncUdpSendPacket
...
@interface BAASSGCDAsyncUdpSpecialPacket : NSObject {
@public
//	uint8_t type;
...
@implementation BAASSGCDAsyncUdpSpecialPacket
...
@implementation BAASSGCDAsyncUdpSocket
...
- (instancetype)initWithDelegate:(id<BAASSGCDAsyncUdpSocketDelegate>)aDelegate delegateQueue:(dispatch_queue_t)dq
{
	LogTrace();
...
- (instancetype)initWithDelegate:(id<BAASSGCDAsyncUdpSocketDelegate>)aDelegate delegateQueue:(dispatch_queue_t)dq socketQueue:(dispatch_queue_t)sq
{
	LogTrace();
	...
	if ((self = [super init]))
	{
		...
		{
			socketQueue = dispatch_queue_create([BAASSGCDAsyncUdpSocketQueueName UTF8String], NULL);
		}
...
- (id<BAASSGCDAsyncUdpSocketDelegate>)delegate
{
	if (dispatch_get_specific(IsOnSocketQueueOrTargetQueueKey))
	{
		return delegate;
...
- (void)setDelegate:(id<BAASSGCDAsyncUdpSocketDelegate>)newDelegate synchronously:(BOOL)synchronously
{
...
- (void)setDelegate:(id<BAASSGCDAsyncUdpSocketDelegate>)newDelegate
{
	[self setDelegate:newDelegate synchronously:NO];
}

- (void)synchronouslySetDelegate:(id<BAASSGCDAsyncUdpSocketDelegate>)newDelegate
{
...
- (void)getDelegate:(id<BAASSGCDAsyncUdpSocketDelegate> *)delegatePtr delegateQueue:(dispatch_queue_t *)delegateQueuePtr
{
	if (dispatch_get_specific(IsOnSocketQueueOrTargetQueueKey))
	{
...
- (void)setDelegate:(id<BAASSGCDAsyncUdpSocketDelegate>)newDelegate delegateQueue:(dispatch_queue_t)newDelegateQueue synchronously:(BOOL)synchronously
{
	dispatch_block_t block = ^{
...
- (void)setDelegate:(id<BAASSGCDAsyncUdpSocketDelegate>)newDelegate delegateQueue:(dispatch_queue_t)newDelegateQueue
{
	[self setDelegate:newDelegate delegateQueue:newDelegateQueue synchronously:NO];
}

- (void)synchronouslySetDelegate:(id<BAASSGCDAsyncUdpSocketDelegate>)newDelegate delegateQueue:(dispatch_queue_t)newDelegateQueue
{
...
- (void)notifyDidConnectToAddress:(NSData *)anAddress
{
	...
	__strong id<BAASSGCDAsyncUdpSocketDelegate> theDelegate = delegate;
...
- (NSError *)badConfigError:(NSString *)errMsg
{
	...
	return [NSError errorWithDomain:BAASSGCDAsyncUdpSocketErrorDomain
	                           code:BAASSGCDAsyncUdpSocketBadConfigError
	                       userInfo:userInfo];
}
...
- (NSError *)badParamError:(NSString *)errMsg
{
	...
	return [NSError errorWithDomain:BAASSGCDAsyncUdpSocketErrorDomain
	                           code:BAASSGCDAsyncUdpSocketBadParamError
	                       userInfo:userInfo];
}
...
{
	NSString *errMsg = NSLocalizedStringWithDefaultValue(@"BAASSGCDAsyncUdpSocketSendTimeoutError",
	                                                     @"BAASSGCDAsyncUdpSocket", [NSBundle mainBundle],
	                                                     @"Send operation timed out", nil);
	
	NSDictionary *userInfo = @{NSLocalizedDescriptionKey : errMsg};
	
	return [NSError errorWithDomain:BAASSGCDAsyncUdpSocketErrorDomain
	                           code:BAASSGCDAsyncUdpSocketSendTimeoutError
	                       userInfo:userInfo];
}

- (NSError *)socketClosedError
{
	NSString *errMsg = NSLocalizedStringWithDefaultValue(@"BAASSGCDAsyncUdpSocketClosedError",
	                                                     @"BAASSGCDAsyncUdpSocket", [NSBundle mainBundle],
	                                                     @"Socket closed", nil);
	
	NSDictionary *userInfo = @{NSLocalizedDescriptionKey : errMsg};
	
	return [NSError errorWithDomain:BAASSGCDAsyncUdpSocketErrorDomain code:BAASSGCDAsyncUdpSocketClosedError userInfo:userInfo];
}
...
- (NSError *)otherError:(NSString *)errMsg
{
	...
	return [NSError errorWithDomain:BAASSGCDAsyncUdpSocketErrorDomain
	                           code:BAASSGCDAsyncUdpSocketOtherError
	                       userInfo:userInfo];
}
...
- (BOOL)createSocket4:(BOOL)useIPv4 socket6:(BOOL)useIPv6 error:(NSError * __autoreleasing *)errPtr
{
	...
	int(^createSocket)(int) = ^int (int domain) {
         ...
         *  #535(BAASSGCDAsyncUDPSocket can not send data when data is greater than 9K)
         *
         *
...
- (BOOL)connectToHost:(NSString *)host onPort:(uint16_t)port error:(NSError **)errPtr
{
	...
	dispatch_block_t block = ^{ @autoreleasepool {
		...
		BAASSGCDAsyncUdpSpecialPacket *packet = [[BAASSGCDAsyncUdpSpecialPacket alloc] init];
...
- (void)maybeConnect
{
	...
	BOOL sendQueueReady = [currentSend isKindOfClass:[BAASSGCDAsyncUdpSpecialPacket class]];
	
	if (sendQueueReady)
	{
		BAASSGCDAsyncUdpSpecialPacket *connectPacket = (BAASSGCDAsyncUdpSpecialPacket *)currentSend;
...
- (void)sendData:(NSData *)data withTimeout:(NSTimeInterval)timeout tag:(long)tag
{
	...
	BAASSGCDAsyncUdpSendPacket *packet = [[BAASSGCDAsyncUdpSendPacket alloc] initWithData:data timeout:timeout tag:tag];
...
- (void)sendData:(NSData *)data toAddress:(NSData *)remoteAddr withTimeout:(NSTimeInterval)timeout tag:(long)tag
{
	...
	BAASSGCDAsyncUdpSendPacket *packet = [[BAASSGCDAsyncUdpSendPacket alloc] initWithData:data timeout:timeout tag:tag];
	packet->addressFamily = [BAASSGCDAsyncUdpSocket familyFromAddress:remoteAddr];
...
- (void)setSendFilter:(BAASSGCDAsyncUdpSocketSendFilterBlock)filterBlock withQueue:(dispatch_queue_t)filterQueue
{
	[self setSendFilter:filterBlock withQueue:filterQueue isAsynchronous:YES];
}

- (void)setSendFilter:(BAASSGCDAsyncUdpSocketSendFilterBlock)filterBlock
            withQueue:(dispatch_queue_t)filterQueue
       isAsynchronous:(BOOL)isAsynchronous
{
	BAASSGCDAsyncUdpSocketSendFilterBlock newFilterBlock = NULL;
...
- (void)maybeDequeueSend
{
	...
	if (currentSend == nil)
	{
		...
		while ([sendQueue count] > 0)
		{
			...
			if ([currentSend isKindOfClass:[BAASSGCDAsyncUdpSpecialPacket class]])
			{
				[self maybeConnect];
...
- (void)doPreSend
{
	...
	if (sendFilterBlock && sendFilterQueue)
	{
		...
		if (sendFilterAsync)
		{
			...
			BAASSGCDAsyncUdpSendPacket *sendPacket = currentSend;
...
- (void)setReceiveFilter:(BAASSGCDAsyncUdpSocketReceiveFilterBlock)filterBlock withQueue:(dispatch_queue_t)filterQueue
{
	[self setReceiveFilter:filterBlock withQueue:filterQueue isAsynchronous:YES];
}

- (void)setReceiveFilter:(BAASSGCDAsyncUdpSocketReceiveFilterBlock)filterBlock
               withQueue:(dispatch_queue_t)filterQueue
          isAsynchronous:(BOOL)isAsynchronous
{
	BAASSGCDAsyncUdpSocketReceiveFilterBlock newFilterBlock = NULL;
	dispatch_queue_t newFilterQueue = NULL;
...
+ (void)listenerThread:(id)unused
{
	@autoreleasepool {
		...
		[[NSThread currentThread] setName:BAASSGCDAsyncUdpSocketThreadName];
...
+ (void)addStreamListener:(BAASSGCDAsyncUdpSocket *)asyncUdpSocket
{
	LogTrace();
...
+ (void)removeStreamListener:(BAASSGCDAsyncUdpSocket *)asyncUdpSocket
{
	LogTrace();
	NSAssert([NSThread currentThread] == listenerThread, @"Invoked on wrong thread");
...
{
	@autoreleasepool {
		BAASSGCDAsyncUdpSocket *asyncUdpSocket = (__bridge BAASSGCDAsyncUdpSocket *)pInfo;
