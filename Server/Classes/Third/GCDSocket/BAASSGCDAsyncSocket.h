...
@class BAASSGCDAsyncReadPacket;
@class BAASSGCDAsyncWritePacket;
@class BAASSGCDAsyncSocketPreBuffer;
@protocol BAASSGCDAsyncSocketDelegate;

NS_ASSUME_NONNULL_BEGIN

extern NSString *const BAASSGCDAsyncSocketException;
extern NSString *const BAASSGCDAsyncSocketErrorDomain;

extern NSString *const BAASSGCDAsyncSocketQueueName;
extern NSString *const BAASSGCDAsyncSocketThreadName;

extern NSString *const BAASSGCDAsyncSocketManuallyEvaluateTrust;
#if TARGET_OS_IPHONE
extern NSString *const BAASSGCDAsyncSocketUseCFStreamForTLS;
#endif
#define BAASSGCDAsyncSocketSSLPeerName     (NSString *)kCFStreamSSLPeerName
#define BAASSGCDAsyncSocketSSLCertificates (NSString *)kCFStreamSSLCertificates
#define BAASSGCDAsyncSocketSSLIsServer     (NSString *)kCFStreamSSLIsServer
extern NSString *const BAASSGCDAsyncSocketSSLPeerID;
extern NSString *const BAASSGCDAsyncSocketSSLProtocolVersionMin;
extern NSString *const BAASSGCDAsyncSocketSSLProtocolVersionMax;
extern NSString *const BAASSGCDAsyncSocketSSLSessionOptionFalseStart;
extern NSString *const BAASSGCDAsyncSocketSSLSessionOptionSendOneByteRecord;
extern NSString *const BAASSGCDAsyncSocketSSLCipherSuites;
#if !TARGET_OS_IPHONE
extern NSString *const BAASSGCDAsyncSocketSSLDiffieHellmanParameters;
#endif

#define BAASSGCDAsyncSocketLoggingContext 65535


typedef NS_ERROR_ENUM(BAASSGCDAsyncSocketErrorDomain, BAASSGCDAsyncSocketError) {
	BAASSGCDAsyncSocketNoError = 0,           // Never used
	BAASSGCDAsyncSocketBadConfigError,        // Invalid configuration
	BAASSGCDAsyncSocketBadParamError,         // Invalid parameter was passed
	BAASSGCDAsyncSocketConnectTimeoutError,   // A connect operation timed out
	BAASSGCDAsyncSocketReadTimeoutError,      // A read operation timed out
	BAASSGCDAsyncSocketWriteTimeoutError,     // A write operation timed out
	BAASSGCDAsyncSocketReadMaxedOutError,     // Reached set maxLength without completing
	BAASSGCDAsyncSocketClosedError,           // The remote peer closed the connection
	BAASSGCDAsyncSocketOtherError,            // Description provided in userInfo
};
...
@interface BAASSGCDAsyncSocket : NSObject

/**
 * BAASSGCDAsyncSocket uses the standard delegate paradigm,
 ...
 * If you pass NULL, BAASSGCDAsyncSocket will automatically create it's own socket queue.
...
- (instancetype)initWithDelegate:(nullable id<BAASSGCDAsyncSocketDelegate>)aDelegate delegateQueue:(nullable dispatch_queue_t)dq;
- (instancetype)initWithDelegate:(nullable id<BAASSGCDAsyncSocketDelegate>)aDelegate delegateQueue:(nullable dispatch_queue_t)dq socketQueue:(nullable dispatch_queue_t)sq NS_DESIGNATED_INITIALIZER;

/**
 * Create BAASSGCDAsyncSocket from already connect BSD socket file descriptor
**/
...
+ (nullable instancetype)socketFromConnectedSocketFD:(int)socketFD delegate:(nullable id<BAASSGCDAsyncSocketDelegate>)aDelegate delegateQueue:(nullable dispatch_queue_t)dq socketQueue:(nullable dispatch_queue_t)sq error:(NSError **)error;

#pragma mark Configuration

@property (atomic, weak, readwrite, nullable) id<BAASSGCDAsyncSocketDelegate> delegate;
...
- (void)getDelegate:(id<BAASSGCDAsyncSocketDelegate> __nullable * __nullable)delegatePtr delegateQueue:(dispatch_queue_t __nullable * __nullable)delegateQueuePtr;
- (void)setDelegate:(nullable id<BAASSGCDAsyncSocketDelegate>)delegate delegateQueue:(nullable dispatch_queue_t)delegateQueue;
...
**/
- (void)synchronouslySetDelegate:(nullable id<BAASSGCDAsyncSocketDelegate>)delegate;
- (void)synchronouslySetDelegateQueue:(nullable dispatch_queue_t)delegateQueue;
- (void)synchronouslySetDelegate:(nullable id<BAASSGCDAsyncSocketDelegate>)delegate delegateQueue:(nullable dispatch_queue_t)delegateQueue;

/**
 * By default, both IPv4 and IPv6 are enabled.
 * 
 * For accepting incoming connections, this means BAASSGCDAsyncSocket automatically supports both protocols,
 * and can simulataneously accept incoming connections on either protocol.
 * 
 * For outgoing connections, this means BAASSGCDAsyncSocket can connect to remote hosts running either protocol.
 * If a DNS lookup returns only IPv4 results, BAASSGCDAsyncSocket will automatically use IPv4.
 * If a DNS lookup returns only IPv6 results, BAASSGCDAsyncSocket will automatically use IPv6.
 ...
 * When a connection is accepted, a new instance of BAASSGCDAsyncSocket will be spawned to handle it,
 ...
 * 
 * Please note the recommended way of releasing a BAASSGCDAsyncSocket instance (e.g. in a dealloc method)
 ...
 * it is treated similarly to a timeout - the socket is closed with a BAASSGCDAsyncSocketReadMaxedOutError.
 ...
 * This is due to the fact that BAASSGCDAsyncSocket does NOT copy the data. It simply retains it.
 ...
 * 
 * - BAASSGCDAsyncSocketManuallyEvaluateTrust
 ...
 *     So BAASSGCDAsyncSocket will invoke the delegate method socket:shouldTrustPeer: passing the SecTrustRef.
 *
 ...
 *
 * - BAASSGCDAsyncSocketUseCFStreamForTLS (iOS only)
 *     The value must be of type NSNumber, encapsulating a BOOL value.
 *     By default BAASSGCDAsyncSocket will use the SecureTransport layer to perform encryption.
 ...
 *     
 *     However, if you absolutely must, you can instruct BAASSGCDAsyncSocket to use the old-fashioned encryption
 *     technique by going through the CFStream instead. So instead of using SecureTransport, BAASSGCDAsyncSocket
 ...
 *     
 *     Thus all the other keys in the given dictionary will be ignored by BAASSGCDAsyncSocket,
 ...
 *
 * - BAASSGCDAsyncSocketSSLProtocolVersionMin
 * - BAASSGCDAsyncSocketSSLProtocolVersionMax
 ...
 * 
 * - BAASSGCDAsyncSocketSSLSessionOptionFalseStart
 *     The value must be of type NSNumber, encapsulating a BOOL value.
 *     See Apple's documentation for kSSLSessionOptionFalseStart.
 * 
 * - BAASSGCDAsyncSocketSSLSessionOptionSendOneByteRecord
 *     The value must be of type NSNumber, encapsulating a BOOL value.
 *     See Apple's documentation for kSSLSessionOptionSendOneByteRecord.
 * 
 * - BAASSGCDAsyncSocketSSLCipherSuites
 ...
 *
 * - BAASSGCDAsyncSocketSSLDiffieHellmanParameters (Mac OS X only)
 *     The value must be of type NSData.
 ...
 *     You MUST use manual trust evaluation instead (see BAASSGCDAsyncSocketManuallyEvaluateTrust).
 ...
 *     You MUST use BAASSGCDAsyncSocketSSLProtocolVersionMin & BAASSGCDAsyncSocketSSLProtocolVersionMin instead.
...
/**
 * BAASSGCDAsyncSocket maintains thread safety by using an internal serial dispatch_queue.
 ...
 * - (dispatch_queue_t)newSocketQueueForConnectionFromAddress:(NSData *)address onSocket:(BAASSGCDAsyncSocket *)sock
 * {
 ...
 * Example usage:
 * 
 * - (void)socket:(BAASSGCDAsyncSocket *)sock didConnectToHost:(NSString *)host port:(uint16_t)port
 * {
...
@protocol BAASSGCDAsyncSocketDelegate <NSObject>
@optional
...
**/
- (nullable dispatch_queue_t)newSocketQueueForConnectionFromAddress:(NSData *)address onSocket:(BAASSGCDAsyncSocket *)sock;
 ...
 * The host parameter will be an IP address, not a DNS name.
 **/
- (void)socket:(BAASSGCDAsyncSocket *)sock didConnectToUrl:(NSURL *)url;
...
**/
- (void)socket:(BAASSGCDAsyncSocket *)sock didReadPartialDataOfLength:(NSUInteger)partialLength tag:(long)tag;

/**
 * Called when a socket has completed writing the requested data. Not called if there is an error.
**/
- (void)socket:(BAASSGCDAsyncSocket *)sock didWriteDataWithTag:(long)tag;

/**
 * Called when a socket has written some data, but has not yet completed the entire write.
 * It may be used for things such as updating progress bars.
**/
- (void)socket:(BAASSGCDAsyncSocket *)sock didWritePartialDataOfLength:(NSUInteger)partialLength tag:(long)tag;
...
**/
- (NSTimeInterval)socket:(BAASSGCDAsyncSocket *)sock shouldTimeoutReadWithTag:(long)tag
...
**/
- (NSTimeInterval)socket:(BAASSGCDAsyncSocket *)sock shouldTimeoutWriteWithTag:(long)tag
                                                                  elapsed:(NSTimeInterval)elapsed
                                                                bytesDone:(NSUInteger)length;
...
**/
- (void)socketDidCloseReadStream:(BAASSGCDAsyncSocket *)sock;
 ...
 * 
 * Note: If the BAASSGCDAsyncSocket instance is deallocated while it is still connected,
...
**/
- (void)socketDidDisconnect:(BAASSGCDAsyncSocket *)sock withError:(nullable NSError *)err;
...
**/
- (void)socketDidSecure:(BAASSGCDAsyncSocket *)sock;

/**
 * Allows a socket delegate to hook into the TLS handshake and manually validate the peer it's connecting to.
 *
 * This is only called if startTLS is invoked with options that include:
 * - BAASSGCDAsyncSocketManuallyEvaluateTrust == YES
 *
...
**/
- (void)socket:(BAASSGCDAsyncSocket *)sock didReceiveTrust:(SecTrustRef)trust
