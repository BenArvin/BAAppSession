...
extern NSString *const BAASSGCDAsyncUdpSocketException;
extern NSString *const BAASSGCDAsyncUdpSocketErrorDomain;

extern NSString *const BAASSGCDAsyncUdpSocketQueueName;
extern NSString *const BAASSGCDAsyncUdpSocketThreadName;

typedef NS_ERROR_ENUM(BAASSGCDAsyncUdpSocketErrorDomain, BAASSGCDAsyncUdpSocketError) {
	BAASSGCDAsyncUdpSocketNoError = 0,          // Never used
	BAASSGCDAsyncUdpSocketBadConfigError,       // Invalid configuration
	BAASSGCDAsyncUdpSocketBadParamError,        // Invalid parameter was passed
	BAASSGCDAsyncUdpSocketSendTimeoutError,     // A send operation timed out
	BAASSGCDAsyncUdpSocketClosedError,          // The socket was closed
	BAASSGCDAsyncUdpSocketOtherError,           // Description provided in userInfo
};
...
@class BAASSGCDAsyncUdpSocket;

@protocol BAASSGCDAsyncUdpSocketDelegate <NSObject>
@optional
...
**/
- (void)udpSocket:(BAASSGCDAsyncUdpSocket *)sock didConnectToAddress:(NSData *)address;
...
**/
- (void)udpSocket:(BAASSGCDAsyncUdpSocket *)sock didNotConnect:(NSError * _Nullable)error;

/**
 * Called when the datagram with the given tag has been sent.
**/
- (void)udpSocket:(BAASSGCDAsyncUdpSocket *)sock didSendDataWithTag:(long)tag;

/**
 * Called if an error occurs while trying to send a datagram.
 * This could be due to a timeout, or something more serious such as the data being too large to fit in a sigle packet.
**/
- (void)udpSocket:(BAASSGCDAsyncUdpSocket *)sock didNotSendDataWithTag:(long)tag dueToError:(NSError * _Nullable)error;

/**
 * Called when the socket has received the requested datagram.
**/
- (void)udpSocket:(BAASSGCDAsyncUdpSocket *)sock didReceiveData:(NSData *)data
...
**/
- (void)udpSocketDidClose:(BAASSGCDAsyncUdpSocket *)sock withError:(NSError  * _Nullable)error;
 ...
 * Example:
 * 
 * BAASSGCDAsyncUdpSocketReceiveFilterBlock filter = ^BOOL (NSData *data, NSData *address, id *context) {
 * 
 ...
 * 
**/
typedef BOOL (^BAASSGCDAsyncUdpSocketReceiveFilterBlock)(NSData *data, NSData *address, id __nullable * __nonnull context);
 ...
 *
**/
typedef BOOL (^BAASSGCDAsyncUdpSocketSendFilterBlock)(NSData *data, NSData *address, long tag);


@interface BAASSGCDAsyncUdpSocket : NSObject

/**
 * BAASSGCDAsyncUdpSocket uses the standard delegate paradigm,
 ...
 * If you pass NULL, BAASSGCDAsyncSocket will automatically create its own socket queue.
...
- (instancetype)initWithDelegate:(nullable id<BAASSGCDAsyncUdpSocketDelegate>)aDelegate delegateQueue:(nullable dispatch_queue_t)dq;
- (instancetype)initWithDelegate:(nullable id<BAASSGCDAsyncUdpSocketDelegate>)aDelegate delegateQueue:(nullable dispatch_queue_t)dq socketQueue:(nullable dispatch_queue_t)sq NS_DESIGNATED_INITIALIZER;

#pragma mark Configuration

- (nullable id<BAASSGCDAsyncUdpSocketDelegate>)delegate;
- (void)setDelegate:(nullable id<BAASSGCDAsyncUdpSocketDelegate>)delegate;
- (void)synchronouslySetDelegate:(nullable id<BAASSGCDAsyncUdpSocketDelegate>)delegate;
...
- (void)getDelegate:(id<BAASSGCDAsyncUdpSocketDelegate> __nullable * __nullable)delegatePtr delegateQueue:(dispatch_queue_t __nullable * __nullable)delegateQueuePtr;
- (void)setDelegate:(nullable id<BAASSGCDAsyncUdpSocketDelegate>)delegate delegateQueue:(nullable dispatch_queue_t)delegateQueue;
- (void)synchronouslySetDelegate:(nullable id<BAASSGCDAsyncUdpSocketDelegate>)delegate delegateQueue:(nullable dispatch_queue_t)delegateQueue;

/**
 * By default, both IPv4 and IPv6 are enabled.
 * 
 * This means BAASSGCDAsyncUdpSocket automatically supports both protocols,
 * and can send to IPv4 or IPv6 addresses,
 * as well as receive over IPv4 and IPv6.
 * 
 * For operations that require DNS resolution, BAASSGCDAsyncUdpSocket supports both IPv4 and IPv6.
 * If a DNS lookup returns only IPv4 results, BAASSGCDAsyncUdpSocket will automatically use IPv4.
 * If a DNS lookup returns only IPv6 results, BAASSGCDAsyncUdpSocket will automatically use IPv6.
 ...
 * This is due to the fact that BAASSGCDAsyncUdpSocket does NOT copy the data.
 ...
 *    or the system tools to handle this aren't available (e.g. on a mobile device).
 * 
 * For more information about BAASSGCDAsyncUdpSocketSendFilterBlock, see the documentation for its typedef.
...
**/
- (void)setSendFilter:(nullable BAASSGCDAsyncUdpSocketSendFilterBlock)filterBlock withQueue:(nullable dispatch_queue_t)filterQueue;
...
**/
- (void)setSendFilter:(nullable BAASSGCDAsyncUdpSocketSendFilterBlock)filterBlock
 ...
 * 
 * Important Note:
 * BAASSGCDAsyncUdpSocket may be running in parallel with your code.
 * That is, your delegate is likely running on a separate thread/dispatch_queue.
 * When you invoke this method, BAASSGCDAsyncUdpSocket may have already dispatched delegate methods to be invoked.
 ...
 * [udpSocket setReceiveFilter:filter withQueue:myParsingQueue];
 * 
 * For more information about BAASSGCDAsyncUdpSocketReceiveFilterBlock, see the documentation for its typedef.
 * To remove a previously set filter, invoke this method and pass a nil filterBlock and NULL filterQueue.
 * 
 * Note: This method invokes setReceiveFilter:withQueue:isAsynchronous: (documented below),
 *       passing YES for the isAsynchronous parameter.
**/
- (void)setReceiveFilter:(nullable BAASSGCDAsyncUdpSocketReceiveFilterBlock)filterBlock withQueue:(nullable dispatch_queue_t)filterQueue;
 ...
 * For example, you can't query properties on the socket.
**/
- (void)setReceiveFilter:(nullable BAASSGCDAsyncUdpSocketReceiveFilterBlock)filterBlock
               withQueue:(nullable dispatch_queue_t)filterQueue
          isAsynchronous:(BOOL)isAsynchronous;
 ...
 * 
 * The BAASSGCDAsyncUdpSocket instance may optionally be used again.
 ...
 * 
 * Generally BAASSGCDAsyncUdpSocket doesn't use CFStream. (It uses the faster GCD API's.)
