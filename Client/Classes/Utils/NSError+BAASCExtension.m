...
@implementation NSError (BAASCExtension)

+ (NSError *)baasc_errorWith:(NSString *)domain code:(NSInteger)code causes:(NSError *)item,...NS_REQUIRES_NIL_TERMINATION {
    ...
    return [self baasc_errorWith:domain code:code description:nil reason:nil recoverySuggestion:nil causesItems:causesItems];
}

+ (NSError *)baasc_errorWith:(NSString *)domain code:(NSInteger)code description:(NSString *)description causes:(NSError *)item,...NS_REQUIRES_NIL_TERMINATION {
    NSMutableArray *causesItems = nil;
    va_list arguments;
    NSError *eachItem;
    if (item) {
    ...
    return [self baasc_errorWith:domain code:code description:description reason:nil recoverySuggestion:nil causesItems:causesItems];
}

+ (NSError *)baasc_errorWith:(NSString *)domain code:(NSInteger)code description:(NSString *)description reason:(NSString *)reason causes:(NSError *)item,...NS_REQUIRES_NIL_TERMINATION {
    NSMutableArray *causesItems = nil;
    va_list arguments;
    NSError *eachItem;
    if (item) {
    ...
    return [self baasc_errorWith:domain code:code description:description reason:reason recoverySuggestion:nil causesItems:causesItems];
}

+ (NSError *)baasc_errorWith:(NSString *)domain code:(NSInteger)code description:(NSString *)description reason:(NSString *)reason recoverySuggestion:(NSString *)recoverySuggestion causes:(NSError *)item,...NS_REQUIRES_NIL_TERMINATION {
    NSMutableArray *causesItems = nil;
    va_list arguments;
    NSError *eachItem;
    if (item) {
    ...
    return [self baasc_errorWith:domain code:code description:description reason:reason recoverySuggestion:recoverySuggestion causesItems:causesItems];
}

#pragma mark - private methods
+ (NSError *)baasc_errorWith:(NSString *)domain code:(NSInteger)code description:(NSString *)description reason:(NSString *)reason recoverySuggestion:(NSString *)recoverySuggestion causesItems:(NSArray <NSError *> *)causesItems {
    ...
    for (NSError *item in causesItems) {
        ...
        [causeDics addObject:[self baasc_toDic:item]];
    }
    if (causeDics) {
        [fullDic setObject:causeDics forKey:gTASCErrorCausesKey];
    }
    NSString *fullStr = [self baasc_toJsonStr:fullDic];
...
+ (NSString *)baasc_toJsonStr:(NSDictionary *)dic {
    if (!dic) {
        return nil;
    }
    NSError *error;
