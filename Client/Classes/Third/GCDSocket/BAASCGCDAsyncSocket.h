...
@class BAASCGCDAsyncReadPacket;
@class BAASCGCDAsyncWritePacket;
@class BAASCGCDAsyncSocketPreBuffer;
@protocol BAASCGCDAsyncSocketDelegate;

NS_ASSUME_NONNULL_BEGIN

extern NSString *const BAASCGCDAsyncSocketException;
extern NSString *const BAASCGCDAsyncSocketErrorDomain;

extern NSString *const BAASCGCDAsyncSocketQueueName;
extern NSString *const BAASCGCDAsyncSocketThreadName;

extern NSString *const BAASCGCDAsyncSocketManuallyEvaluateTrust;
#if TARGET_OS_IPHONE
extern NSString *const BAASCGCDAsyncSocketUseCFStreamForTLS;
#endif
#define BAASCGCDAsyncSocketSSLPeerName     (NSString *)kCFStreamSSLPeerName
#define BAASCGCDAsyncSocketSSLCertificates (NSString *)kCFStreamSSLCertificates
#define BAASCGCDAsyncSocketSSLIsServer     (NSString *)kCFStreamSSLIsServer
extern NSString *const BAASCGCDAsyncSocketSSLPeerID;
extern NSString *const BAASCGCDAsyncSocketSSLProtocolVersionMin;
extern NSString *const BAASCGCDAsyncSocketSSLProtocolVersionMax;
extern NSString *const BAASCGCDAsyncSocketSSLSessionOptionFalseStart;
extern NSString *const BAASCGCDAsyncSocketSSLSessionOptionSendOneByteRecord;
extern NSString *const BAASCGCDAsyncSocketSSLCipherSuites;
#if !TARGET_OS_IPHONE
extern NSString *const BAASCGCDAsyncSocketSSLDiffieHellmanParameters;
#endif

#define BAASCGCDAsyncSocketLoggingContext 65535


typedef NS_ERROR_ENUM(BAASCGCDAsyncSocketErrorDomain, BAASCGCDAsyncSocketError) {
	BAASCGCDAsyncSocketNoError = 0,           // Never used
	BAASCGCDAsyncSocketBadConfigError,        // Invalid configuration
	BAASCGCDAsyncSocketBadParamError,         // Invalid parameter was passed
	BAASCGCDAsyncSocketConnectTimeoutError,   // A connect operation timed out
	BAASCGCDAsyncSocketReadTimeoutError,      // A read operation timed out
	BAASCGCDAsyncSocketWriteTimeoutError,     // A write operation timed out
	BAASCGCDAsyncSocketReadMaxedOutError,     // Reached set maxLength without completing
	BAASCGCDAsyncSocketClosedError,           // The remote peer closed the connection
	BAASCGCDAsyncSocketOtherError,            // Description provided in userInfo
};
...
@interface BAASCGCDAsyncSocket : NSObject

/**
 * BAASCGCDAsyncSocket uses the standard delegate paradigm,
 ...
 * If you pass NULL, BAASCGCDAsyncSocket will automatically create it's own socket queue.
...
- (instancetype)initWithDelegate:(nullable id<BAASCGCDAsyncSocketDelegate>)aDelegate delegateQueue:(nullable dispatch_queue_t)dq;
- (instancetype)initWithDelegate:(nullable id<BAASCGCDAsyncSocketDelegate>)aDelegate delegateQueue:(nullable dispatch_queue_t)dq socketQueue:(nullable dispatch_queue_t)sq NS_DESIGNATED_INITIALIZER;

/**
 * Create BAASCGCDAsyncSocket from already connect BSD socket file descriptor
**/
...
+ (nullable instancetype)socketFromConnectedSocketFD:(int)socketFD delegate:(nullable id<BAASCGCDAsyncSocketDelegate>)aDelegate delegateQueue:(nullable dispatch_queue_t)dq socketQueue:(nullable dispatch_queue_t)sq error:(NSError **)error;

#pragma mark Configuration

@property (atomic, weak, readwrite, nullable) id<BAASCGCDAsyncSocketDelegate> delegate;
...
- (void)getDelegate:(id<BAASCGCDAsyncSocketDelegate> __nullable * __nullable)delegatePtr delegateQueue:(dispatch_queue_t __nullable * __nullable)delegateQueuePtr;
- (void)setDelegate:(nullable id<BAASCGCDAsyncSocketDelegate>)delegate delegateQueue:(nullable dispatch_queue_t)delegateQueue;
...
**/
- (void)synchronouslySetDelegate:(nullable id<BAASCGCDAsyncSocketDelegate>)delegate;
- (void)synchronouslySetDelegateQueue:(nullable dispatch_queue_t)delegateQueue;
- (void)synchronouslySetDelegate:(nullable id<BAASCGCDAsyncSocketDelegate>)delegate delegateQueue:(nullable dispatch_queue_t)delegateQueue;

/**
 * By default, both IPv4 and IPv6 are enabled.
 * 
 * For accepting incoming connections, this means BAASCGCDAsyncSocket automatically supports both protocols,
 * and can simulataneously accept incoming connections on either protocol.
 * 
 * For outgoing connections, this means BAASCGCDAsyncSocket can connect to remote hosts running either protocol.
 * If a DNS lookup returns only IPv4 results, BAASCGCDAsyncSocket will automatically use IPv4.
 * If a DNS lookup returns only IPv6 results, BAASCGCDAsyncSocket will automatically use IPv6.
 ...
 * When a connection is accepted, a new instance of BAASCGCDAsyncSocket will be spawned to handle it,
 ...
 * 
 * Please note the recommended way of releasing a BAASCGCDAsyncSocket instance (e.g. in a dealloc method)
 ...
 * it is treated similarly to a timeout - the socket is closed with a BAASCGCDAsyncSocketReadMaxedOutError.
 ...
 * This is due to the fact that BAASCGCDAsyncSocket does NOT copy the data. It simply retains it.
 ...
 * 
 * - BAASCGCDAsyncSocketManuallyEvaluateTrust
 ...
 *     So BAASCGCDAsyncSocket will invoke the delegate method socket:shouldTrustPeer: passing the SecTrustRef.
 *
 ...
 *
 * - BAASCGCDAsyncSocketUseCFStreamForTLS (iOS only)
 *     The value must be of type NSNumber, encapsulating a BOOL value.
 *     By default BAASCGCDAsyncSocket will use the SecureTransport layer to perform encryption.
 ...
 *     
 *     However, if you absolutely must, you can instruct BAASCGCDAsyncSocket to use the old-fashioned encryption
 *     technique by going through the CFStream instead. So instead of using SecureTransport, BAASCGCDAsyncSocket
 ...
 *     
 *     Thus all the other keys in the given dictionary will be ignored by BAASCGCDAsyncSocket,
 ...
 *
 * - BAASCGCDAsyncSocketSSLProtocolVersionMin
 * - BAASCGCDAsyncSocketSSLProtocolVersionMax
 ...
 * 
 * - BAASCGCDAsyncSocketSSLSessionOptionFalseStart
 *     The value must be of type NSNumber, encapsulating a BOOL value.
 *     See Apple's documentation for kSSLSessionOptionFalseStart.
 * 
 * - BAASCGCDAsyncSocketSSLSessionOptionSendOneByteRecord
 *     The value must be of type NSNumber, encapsulating a BOOL value.
 *     See Apple's documentation for kSSLSessionOptionSendOneByteRecord.
 * 
 * - BAASCGCDAsyncSocketSSLCipherSuites
 ...
 *
 * - BAASCGCDAsyncSocketSSLDiffieHellmanParameters (Mac OS X only)
 *     The value must be of type NSData.
 ...
 *     You MUST use manual trust evaluation instead (see BAASCGCDAsyncSocketManuallyEvaluateTrust).
 ...
 *     You MUST use BAASCGCDAsyncSocketSSLProtocolVersionMin & BAASCGCDAsyncSocketSSLProtocolVersionMin instead.
...
/**
 * BAASCGCDAsyncSocket maintains thread safety by using an internal serial dispatch_queue.
 ...
 * - (dispatch_queue_t)newSocketQueueForConnectionFromAddress:(NSData *)address onSocket:(BAASCGCDAsyncSocket *)sock
 * {
 ...
 *     return socketQueue;
 * }
 * - (void)socket:(BAASCGCDAsyncSocket *)sock didAcceptNewSocket:(BAASCGCDAsyncSocket *)newSocket
 * {
...
@protocol BAASCGCDAsyncSocketDelegate <NSObject>
@optional
...
**/
- (nullable dispatch_queue_t)newSocketQueueForConnectionFromAddress:(NSData *)address onSocket:(BAASCGCDAsyncSocket *)sock;
 ...
 * The host parameter will be an IP address, not a DNS name.
 **/
- (void)socket:(BAASCGCDAsyncSocket *)sock didConnectToUrl:(NSURL *)url;
...
**/
- (void)socket:(BAASCGCDAsyncSocket *)sock didReadPartialDataOfLength:(NSUInteger)partialLength tag:(long)tag;

/**
 * Called when a socket has completed writing the requested data. Not called if there is an error.
**/
- (void)socket:(BAASCGCDAsyncSocket *)sock didWriteDataWithTag:(long)tag;

/**
 * Called when a socket has written some data, but has not yet completed the entire write.
 * It may be used for things such as updating progress bars.
**/
- (void)socket:(BAASCGCDAsyncSocket *)sock didWritePartialDataOfLength:(NSUInteger)partialLength tag:(long)tag;
...
**/
- (NSTimeInterval)socket:(BAASCGCDAsyncSocket *)sock shouldTimeoutReadWithTag:(long)tag
...
**/
- (NSTimeInterval)socket:(BAASCGCDAsyncSocket *)sock shouldTimeoutWriteWithTag:(long)tag
                                                                  elapsed:(NSTimeInterval)elapsed
                                                                bytesDone:(NSUInteger)length;
...
**/
- (void)socketDidCloseReadStream:(BAASCGCDAsyncSocket *)sock;
 ...
 * 
 * Note: If the BAASCGCDAsyncSocket instance is deallocated while it is still connected,
...
**/
- (void)socketDidDisconnect:(BAASCGCDAsyncSocket *)sock withError:(nullable NSError *)err;
...
**/
- (void)socketDidSecure:(BAASCGCDAsyncSocket *)sock;

/**
 * Allows a socket delegate to hook into the TLS handshake and manually validate the peer it's connecting to.
 *
 * This is only called if startTLS is invoked with options that include:
 * - BAASCGCDAsyncSocketManuallyEvaluateTrust == YES
 *
...
**/
- (void)socket:(BAASCGCDAsyncSocket *)sock didReceiveTrust:(SecTrustRef)trust
