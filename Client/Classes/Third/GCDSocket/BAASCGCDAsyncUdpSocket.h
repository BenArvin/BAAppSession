...
extern NSString *const BAASCGCDAsyncUdpSocketException;
extern NSString *const BAASCGCDAsyncUdpSocketErrorDomain;

extern NSString *const BAASCGCDAsyncUdpSocketQueueName;
extern NSString *const BAASCGCDAsyncUdpSocketThreadName;

typedef NS_ERROR_ENUM(BAASCGCDAsyncUdpSocketErrorDomain, BAASCGCDAsyncUdpSocketError) {
	BAASCGCDAsyncUdpSocketNoError = 0,          // Never used
	BAASCGCDAsyncUdpSocketBadConfigError,       // Invalid configuration
	BAASCGCDAsyncUdpSocketBadParamError,        // Invalid parameter was passed
	BAASCGCDAsyncUdpSocketSendTimeoutError,     // A send operation timed out
	BAASCGCDAsyncUdpSocketClosedError,          // The socket was closed
	BAASCGCDAsyncUdpSocketOtherError,           // Description provided in userInfo
};
...
@class BAASCGCDAsyncUdpSocket;

@protocol BAASCGCDAsyncUdpSocketDelegate <NSObject>
@optional
...
**/
- (void)udpSocket:(BAASCGCDAsyncUdpSocket *)sock didConnectToAddress:(NSData *)address;
...
**/
- (void)udpSocket:(BAASCGCDAsyncUdpSocket *)sock didNotConnect:(NSError * _Nullable)error;

/**
 * Called when the datagram with the given tag has been sent.
**/
- (void)udpSocket:(BAASCGCDAsyncUdpSocket *)sock didSendDataWithTag:(long)tag;

/**
 * Called if an error occurs while trying to send a datagram.
 * This could be due to a timeout, or something more serious such as the data being too large to fit in a sigle packet.
**/
- (void)udpSocket:(BAASCGCDAsyncUdpSocket *)sock didNotSendDataWithTag:(long)tag dueToError:(NSError * _Nullable)error;

/**
 * Called when the socket has received the requested datagram.
**/
- (void)udpSocket:(BAASCGCDAsyncUdpSocket *)sock didReceiveData:(NSData *)data
...
**/
- (void)udpSocketDidClose:(BAASCGCDAsyncUdpSocket *)sock withError:(NSError  * _Nullable)error;
 ...
 * Example:
 * 
 * BAASCGCDAsyncUdpSocketReceiveFilterBlock filter = ^BOOL (NSData *data, NSData *address, id *context) {
 * 
 ...
 * 
**/
typedef BOOL (^BAASCGCDAsyncUdpSocketReceiveFilterBlock)(NSData *data, NSData *address, id __nullable * __nonnull context);
 ...
 *
**/
typedef BOOL (^BAASCGCDAsyncUdpSocketSendFilterBlock)(NSData *data, NSData *address, long tag);


@interface BAASCGCDAsyncUdpSocket : NSObject

/**
 * BAASCGCDAsyncUdpSocket uses the standard delegate paradigm,
 ...
 * If you pass NULL, BAASCGCDAsyncSocket will automatically create its own socket queue.
...
- (instancetype)initWithDelegate:(nullable id<BAASCGCDAsyncUdpSocketDelegate>)aDelegate delegateQueue:(nullable dispatch_queue_t)dq;
- (instancetype)initWithDelegate:(nullable id<BAASCGCDAsyncUdpSocketDelegate>)aDelegate delegateQueue:(nullable dispatch_queue_t)dq socketQueue:(nullable dispatch_queue_t)sq NS_DESIGNATED_INITIALIZER;

#pragma mark Configuration

- (nullable id<BAASCGCDAsyncUdpSocketDelegate>)delegate;
- (void)setDelegate:(nullable id<BAASCGCDAsyncUdpSocketDelegate>)delegate;
- (void)synchronouslySetDelegate:(nullable id<BAASCGCDAsyncUdpSocketDelegate>)delegate;
...
- (void)getDelegate:(id<BAASCGCDAsyncUdpSocketDelegate> __nullable * __nullable)delegatePtr delegateQueue:(dispatch_queue_t __nullable * __nullable)delegateQueuePtr;
- (void)setDelegate:(nullable id<BAASCGCDAsyncUdpSocketDelegate>)delegate delegateQueue:(nullable dispatch_queue_t)delegateQueue;
- (void)synchronouslySetDelegate:(nullable id<BAASCGCDAsyncUdpSocketDelegate>)delegate delegateQueue:(nullable dispatch_queue_t)delegateQueue;

/**
 * By default, both IPv4 and IPv6 are enabled.
 * 
 * This means BAASCGCDAsyncUdpSocket automatically supports both protocols,
 * and can send to IPv4 or IPv6 addresses,
 * as well as receive over IPv4 and IPv6.
 * 
 * For operations that require DNS resolution, BAASCGCDAsyncUdpSocket supports both IPv4 and IPv6.
 * If a DNS lookup returns only IPv4 results, BAASCGCDAsyncUdpSocket will automatically use IPv4.
 * If a DNS lookup returns only IPv6 results, BAASCGCDAsyncUdpSocket will automatically use IPv6.
 ...
 * This is due to the fact that BAASCGCDAsyncUdpSocket does NOT copy the data.
 ...
 *    or the system tools to handle this aren't available (e.g. on a mobile device).
 * 
 * For more information about BAASCGCDAsyncUdpSocketSendFilterBlock, see the documentation for its typedef.
...
**/
- (void)setSendFilter:(nullable BAASCGCDAsyncUdpSocketSendFilterBlock)filterBlock withQueue:(nullable dispatch_queue_t)filterQueue;
...
**/
- (void)setSendFilter:(nullable BAASCGCDAsyncUdpSocketSendFilterBlock)filterBlock
 ...
 * 
 * Important Note:
 * BAASCGCDAsyncUdpSocket may be running in parallel with your code.
 * That is, your delegate is likely running on a separate thread/dispatch_queue.
 * When you invoke this method, BAASCGCDAsyncUdpSocket may have already dispatched delegate methods to be invoked.
 ...
 * [udpSocket setReceiveFilter:filter withQueue:myParsingQueue];
 * 
 * For more information about BAASCGCDAsyncUdpSocketReceiveFilterBlock, see the documentation for its typedef.
 * To remove a previously set filter, invoke this method and pass a nil filterBlock and NULL filterQueue.
 * 
 * Note: This method invokes setReceiveFilter:withQueue:isAsynchronous: (documented below),
 *       passing YES for the isAsynchronous parameter.
**/
- (void)setReceiveFilter:(nullable BAASCGCDAsyncUdpSocketReceiveFilterBlock)filterBlock withQueue:(nullable dispatch_queue_t)filterQueue;
 ...
 * For example, you can't query properties on the socket.
**/
- (void)setReceiveFilter:(nullable BAASCGCDAsyncUdpSocketReceiveFilterBlock)filterBlock
               withQueue:(nullable dispatch_queue_t)filterQueue
          isAsynchronous:(BOOL)isAsynchronous;
 ...
 * 
 * The BAASCGCDAsyncUdpSocket instance may optionally be used again.
 ...
 * 
 * Generally BAASCGCDAsyncUdpSocket doesn't use CFStream. (It uses the faster GCD API's.)
