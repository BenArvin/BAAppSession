...
@class BAASCGCDAsyncUdpSendPacket;

NSString *const BAASCGCDAsyncUdpSocketException = @"BAASCGCDAsyncUdpSocketException";
NSString *const BAASCGCDAsyncUdpSocketErrorDomain = @"BAASCGCDAsyncUdpSocketErrorDomain";

NSString *const BAASCGCDAsyncUdpSocketQueueName = @"BAASCGCDAsyncUdpSocket";
NSString *const BAASCGCDAsyncUdpSocketThreadName = @"BAASCGCDAsyncUdpSocket-CFStream";

enum BAASCGCDAsyncUdpSocketFlags
{
...
enum BAASCGCDAsyncUdpSocketConfig
{
...
@interface BAASCGCDAsyncUdpSocket ()
{
	...
	BAASCGCDAsyncUdpSocketReceiveFilterBlock receiveFilterBlock;
	dispatch_queue_t receiveFilterQueue;
	BOOL receiveFilterAsync;
	
	BAASCGCDAsyncUdpSocketSendFilterBlock sendFilterBlock;
	...
	BAASCGCDAsyncUdpSendPacket *currentSend;
...
/**
 * The BAASCGCDAsyncUdpSendPacket encompasses the instructions for a single send/write.
**/
@interface BAASCGCDAsyncUdpSendPacket : NSObject {
@public
	NSData *buffer;
...
@implementation BAASCGCDAsyncUdpSendPacket
...
@interface BAASCGCDAsyncUdpSpecialPacket : NSObject {
@public
//	uint8_t type;
...
@implementation BAASCGCDAsyncUdpSpecialPacket
...
@implementation BAASCGCDAsyncUdpSocket
...
- (instancetype)initWithDelegate:(id<BAASCGCDAsyncUdpSocketDelegate>)aDelegate delegateQueue:(dispatch_queue_t)dq
{
	LogTrace();
...
- (instancetype)initWithDelegate:(id<BAASCGCDAsyncUdpSocketDelegate>)aDelegate delegateQueue:(dispatch_queue_t)dq socketQueue:(dispatch_queue_t)sq
{
	LogTrace();
	...
	if ((self = [super init]))
	{
		...
		{
			socketQueue = dispatch_queue_create([BAASCGCDAsyncUdpSocketQueueName UTF8String], NULL);
		}
...
- (id<BAASCGCDAsyncUdpSocketDelegate>)delegate
{
	if (dispatch_get_specific(IsOnSocketQueueOrTargetQueueKey))
	{
		return delegate;
...
- (void)setDelegate:(id<BAASCGCDAsyncUdpSocketDelegate>)newDelegate synchronously:(BOOL)synchronously
{
...
- (void)setDelegate:(id<BAASCGCDAsyncUdpSocketDelegate>)newDelegate
{
	[self setDelegate:newDelegate synchronously:NO];
}

- (void)synchronouslySetDelegate:(id<BAASCGCDAsyncUdpSocketDelegate>)newDelegate
{
...
- (void)getDelegate:(id<BAASCGCDAsyncUdpSocketDelegate> *)delegatePtr delegateQueue:(dispatch_queue_t *)delegateQueuePtr
{
	if (dispatch_get_specific(IsOnSocketQueueOrTargetQueueKey))
	{
...
- (void)setDelegate:(id<BAASCGCDAsyncUdpSocketDelegate>)newDelegate delegateQueue:(dispatch_queue_t)newDelegateQueue synchronously:(BOOL)synchronously
{
	dispatch_block_t block = ^{
...
- (void)setDelegate:(id<BAASCGCDAsyncUdpSocketDelegate>)newDelegate delegateQueue:(dispatch_queue_t)newDelegateQueue
{
	[self setDelegate:newDelegate delegateQueue:newDelegateQueue synchronously:NO];
}

- (void)synchronouslySetDelegate:(id<BAASCGCDAsyncUdpSocketDelegate>)newDelegate delegateQueue:(dispatch_queue_t)newDelegateQueue
{
...
- (void)notifyDidConnectToAddress:(NSData *)anAddress
{
	...
	__strong id<BAASCGCDAsyncUdpSocketDelegate> theDelegate = delegate;
...
- (NSError *)badConfigError:(NSString *)errMsg
{
	...
	return [NSError errorWithDomain:BAASCGCDAsyncUdpSocketErrorDomain
	                           code:BAASCGCDAsyncUdpSocketBadConfigError
	                       userInfo:userInfo];
}
...
- (NSError *)badParamError:(NSString *)errMsg
{
	...
	return [NSError errorWithDomain:BAASCGCDAsyncUdpSocketErrorDomain
	                           code:BAASCGCDAsyncUdpSocketBadParamError
	                       userInfo:userInfo];
}
...
{
	NSString *errMsg = NSLocalizedStringWithDefaultValue(@"BAASCGCDAsyncUdpSocketSendTimeoutError",
	                                                     @"BAASCGCDAsyncUdpSocket", [NSBundle mainBundle],
	                                                     @"Send operation timed out", nil);
	
	NSDictionary *userInfo = @{NSLocalizedDescriptionKey : errMsg};
	
	return [NSError errorWithDomain:BAASCGCDAsyncUdpSocketErrorDomain
	                           code:BAASCGCDAsyncUdpSocketSendTimeoutError
	                       userInfo:userInfo];
}

- (NSError *)socketClosedError
{
	NSString *errMsg = NSLocalizedStringWithDefaultValue(@"BAASCGCDAsyncUdpSocketClosedError",
	                                                     @"BAASCGCDAsyncUdpSocket", [NSBundle mainBundle],
	                                                     @"Socket closed", nil);
	
	NSDictionary *userInfo = @{NSLocalizedDescriptionKey : errMsg};
	
	return [NSError errorWithDomain:BAASCGCDAsyncUdpSocketErrorDomain code:BAASCGCDAsyncUdpSocketClosedError userInfo:userInfo];
}
...
- (NSError *)otherError:(NSString *)errMsg
{
	...
	return [NSError errorWithDomain:BAASCGCDAsyncUdpSocketErrorDomain
	                           code:BAASCGCDAsyncUdpSocketOtherError
	                       userInfo:userInfo];
}
...
- (BOOL)createSocket4:(BOOL)useIPv4 socket6:(BOOL)useIPv6 error:(NSError * __autoreleasing *)errPtr
{
	...
	int(^createSocket)(int) = ^int (int domain) {
         ...
         *  #535(BAASCGCDAsyncUDPSocket can not send data when data is greater than 9K)
         *
         *
...
- (BOOL)connectToHost:(NSString *)host onPort:(uint16_t)port error:(NSError **)errPtr
{
	...
	dispatch_block_t block = ^{ @autoreleasepool {
		...
		BAASCGCDAsyncUdpSpecialPacket *packet = [[BAASCGCDAsyncUdpSpecialPacket alloc] init];
...
- (void)maybeConnect
{
	...
	BOOL sendQueueReady = [currentSend isKindOfClass:[BAASCGCDAsyncUdpSpecialPacket class]];
	
	if (sendQueueReady)
	{
		BAASCGCDAsyncUdpSpecialPacket *connectPacket = (BAASCGCDAsyncUdpSpecialPacket *)currentSend;
...
- (void)sendData:(NSData *)data withTimeout:(NSTimeInterval)timeout tag:(long)tag
{
	...
	BAASCGCDAsyncUdpSendPacket *packet = [[BAASCGCDAsyncUdpSendPacket alloc] initWithData:data timeout:timeout tag:tag];
...
- (void)sendData:(NSData *)data toAddress:(NSData *)remoteAddr withTimeout:(NSTimeInterval)timeout tag:(long)tag
{
	...
	BAASCGCDAsyncUdpSendPacket *packet = [[BAASCGCDAsyncUdpSendPacket alloc] initWithData:data timeout:timeout tag:tag];
	packet->addressFamily = [BAASCGCDAsyncUdpSocket familyFromAddress:remoteAddr];
...
- (void)setSendFilter:(BAASCGCDAsyncUdpSocketSendFilterBlock)filterBlock withQueue:(dispatch_queue_t)filterQueue
{
	[self setSendFilter:filterBlock withQueue:filterQueue isAsynchronous:YES];
}

- (void)setSendFilter:(BAASCGCDAsyncUdpSocketSendFilterBlock)filterBlock
            withQueue:(dispatch_queue_t)filterQueue
       isAsynchronous:(BOOL)isAsynchronous
{
	BAASCGCDAsyncUdpSocketSendFilterBlock newFilterBlock = NULL;
...
- (void)maybeDequeueSend
{
	...
	if (currentSend == nil)
	{
		...
		while ([sendQueue count] > 0)
		{
			...
			if ([currentSend isKindOfClass:[BAASCGCDAsyncUdpSpecialPacket class]])
			{
				[self maybeConnect];
...
- (void)doPreSend
{
	...
	if (sendFilterBlock && sendFilterQueue)
	{
		...
		if (sendFilterAsync)
		{
			...
			BAASCGCDAsyncUdpSendPacket *sendPacket = currentSend;
...
- (void)setReceiveFilter:(BAASCGCDAsyncUdpSocketReceiveFilterBlock)filterBlock withQueue:(dispatch_queue_t)filterQueue
{
	[self setReceiveFilter:filterBlock withQueue:filterQueue isAsynchronous:YES];
}

- (void)setReceiveFilter:(BAASCGCDAsyncUdpSocketReceiveFilterBlock)filterBlock
               withQueue:(dispatch_queue_t)filterQueue
          isAsynchronous:(BOOL)isAsynchronous
{
	BAASCGCDAsyncUdpSocketReceiveFilterBlock newFilterBlock = NULL;
	dispatch_queue_t newFilterQueue = NULL;
...
+ (void)listenerThread:(id)unused
{
	@autoreleasepool {
		...
		[[NSThread currentThread] setName:BAASCGCDAsyncUdpSocketThreadName];
...
+ (void)addStreamListener:(BAASCGCDAsyncUdpSocket *)asyncUdpSocket
{
	LogTrace();
...
+ (void)removeStreamListener:(BAASCGCDAsyncUdpSocket *)asyncUdpSocket
{
	LogTrace();
	NSAssert([NSThread currentThread] == listenerThread, @"Invoked on wrong thread");
...
{
	@autoreleasepool {
		BAASCGCDAsyncUdpSocket *asyncUdpSocket = (__bridge BAASCGCDAsyncUdpSocket *)pInfo;
