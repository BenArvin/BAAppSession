...
#ifndef BAASCGCDAsyncSocketLoggingEnabled
#define BAASCGCDAsyncSocketLoggingEnabled 0
#endif

#if BAASCGCDAsyncSocketLoggingEnabled
...
#define LogAsync   YES
#define LogContext BAASCGCDAsyncSocketLoggingContext
...
#ifndef BAASCGCDAsyncSocketLogLevel
#define BAASCGCDAsyncSocketLogLevel LOG_LEVEL_VERBOSE
#endif

// Log levels : off, error, warn, info, verbose
static const int logLevel = BAASCGCDAsyncSocketLogLevel;
...
NSString *const BAASCGCDAsyncSocketException = @"BAASCGCDAsyncSocketException";
NSString *const BAASCGCDAsyncSocketErrorDomain = @"BAASCGCDAsyncSocketErrorDomain";

NSString *const BAASCGCDAsyncSocketQueueName = @"BAASCGCDAsyncSocket";
NSString *const BAASCGCDAsyncSocketThreadName = @"BAASCGCDAsyncSocket-CFStream";

NSString *const BAASCGCDAsyncSocketManuallyEvaluateTrust = @"BAASCGCDAsyncSocketManuallyEvaluateTrust";
#if TARGET_OS_IPHONE
NSString *const BAASCGCDAsyncSocketUseCFStreamForTLS = @"BAASCGCDAsyncSocketUseCFStreamForTLS";
#endif
NSString *const BAASCGCDAsyncSocketSSLPeerID = @"BAASCGCDAsyncSocketSSLPeerID";
NSString *const BAASCGCDAsyncSocketSSLProtocolVersionMin = @"BAASCGCDAsyncSocketSSLProtocolVersionMin";
NSString *const BAASCGCDAsyncSocketSSLProtocolVersionMax = @"BAASCGCDAsyncSocketSSLProtocolVersionMax";
NSString *const BAASCGCDAsyncSocketSSLSessionOptionFalseStart = @"BAASCGCDAsyncSocketSSLSessionOptionFalseStart";
NSString *const BAASCGCDAsyncSocketSSLSessionOptionSendOneByteRecord = @"BAASCGCDAsyncSocketSSLSessionOptionSendOneByteRecord";
NSString *const BAASCGCDAsyncSocketSSLCipherSuites = @"BAASCGCDAsyncSocketSSLCipherSuites";
#if !TARGET_OS_IPHONE
NSString *const BAASCGCDAsyncSocketSSLDiffieHellmanParameters = @"BAASCGCDAsyncSocketSSLDiffieHellmanParameters";
#endif

enum BAASCGCDAsyncSocketFlags
{
...
enum BAASCGCDAsyncSocketConfig
{
...
@interface BAASCGCDAsyncSocketPreBuffer : NSObject
{
	uint8_t *preBuffer;
...
@implementation BAASCGCDAsyncSocketPreBuffer
...
/**
 * The BAASCGCDAsyncReadPacket encompasses the instructions for any given read.
 * The content of a read packet allows the code to determine if we're:
 *  - reading to a certain length
 *  - reading to a certain separator
 *  - or simply reading the first chunk of available data
**/
@interface BAASCGCDAsyncReadPacket : NSObject
{
  @public
...
- (NSUInteger)readLengthForTermWithPreBuffer:(BAASCGCDAsyncSocketPreBuffer *)preBuffer found:(BOOL *)foundPtr;

- (NSInteger)searchForTermAfterPreBuffering:(ssize_t)numBytes;

@end

@implementation BAASCGCDAsyncReadPacket
...
/**
 * The BAASCGCDAsyncWritePacket encompasses the instructions for any given write.
**/
@interface BAASCGCDAsyncWritePacket : NSObject
{
  @public
	NSData *buffer;
	NSUInteger bytesDone;
...
@implementation BAASCGCDAsyncWritePacket
...
/**
 * The BAASCGCDAsyncSpecialPacket encompasses special instructions for interruptions in the read/write queues.
 * This class my be altered to support more than just TLS in the future.
**/
@interface BAASCGCDAsyncSpecialPacket : NSObject
{
  @public
...
@implementation BAASCGCDAsyncSpecialPacket
...
@implementation BAASCGCDAsyncSocket
{
	uint32_t flags;
	uint16_t config;
	
	__weak id<BAASCGCDAsyncSocketDelegate> delegate;
	...
	BAASCGCDAsyncReadPacket *currentRead;
	BAASCGCDAsyncWritePacket *currentWrite;
	
	unsigned long socketFDBytesAvailable;
	
	BAASCGCDAsyncSocketPreBuffer *preBuffer;
	...
	BAASCGCDAsyncSocketPreBuffer *sslPreBuffer;
...
- (instancetype)initWithDelegate:(id<BAASCGCDAsyncSocketDelegate>)aDelegate delegateQueue:(dispatch_queue_t)dq
{
	return [self initWithDelegate:aDelegate delegateQueue:dq socketQueue:NULL];
}

- (instancetype)initWithDelegate:(id<BAASCGCDAsyncSocketDelegate>)aDelegate delegateQueue:(dispatch_queue_t)dq socketQueue:(dispatch_queue_t)sq
{
	if((self = [super init]))
	{
		delegate = aDelegate;
		...
		{
			socketQueue = dispatch_queue_create([BAASCGCDAsyncSocketQueueName UTF8String], NULL);
		}
		...
		preBuffer = [[BAASCGCDAsyncSocketPreBuffer alloc] initWithCapacity:(1024 * 4)];
...
+ (nullable instancetype)socketFromConnectedSocketFD:(int)socketFD delegate:(nullable id<BAASCGCDAsyncSocketDelegate>)aDelegate delegateQueue:(nullable dispatch_queue_t)dq error:(NSError**)error {
  return [self socketFromConnectedSocketFD:socketFD delegate:aDelegate delegateQueue:dq socketQueue:NULL error:error];
}

+ (nullable instancetype)socketFromConnectedSocketFD:(int)socketFD delegate:(nullable id<BAASCGCDAsyncSocketDelegate>)aDelegate delegateQueue:(nullable dispatch_queue_t)dq socketQueue:(nullable dispatch_queue_t)sq error:(NSError* __autoreleasing *)error
{
  __block BOOL errorOccured = NO;
  
  BAASCGCDAsyncSocket *socket = [[[self class] alloc] initWithDelegate:aDelegate delegateQueue:dq socketQueue:sq];
  ...
  dispatch_sync(socket->socketQueue, ^{ @autoreleasepool {
    ...
    if (retVal)
    {
      NSString *errMsg = NSLocalizedStringWithDefaultValue(@"BAASCGCDAsyncSocketOtherError",
                                                           @"BAASCGCDAsyncSocket", [NSBundle mainBundle],
      ...
      errorOccured = YES;
      if (error)
        *error = [NSError errorWithDomain:BAASCGCDAsyncSocketErrorDomain code:BAASCGCDAsyncSocketOtherError userInfo:userInfo];
      return;
    }
...
- (void)setDelegate:(id<BAASCGCDAsyncSocketDelegate>)newDelegate
{
	[self setDelegate:newDelegate synchronously:NO];
}

- (void)synchronouslySetDelegate:(id<BAASCGCDAsyncSocketDelegate>)newDelegate
{
...
- (void)getDelegate:(id<BAASCGCDAsyncSocketDelegate> *)delegatePtr delegateQueue:(dispatch_queue_t *)delegateQueuePtr
{
	if (dispatch_get_specific(IsOnSocketQueueOrTargetQueueKey))
	{
...
- (void)setDelegate:(id<BAASCGCDAsyncSocketDelegate>)newDelegate delegateQueue:(dispatch_queue_t)newDelegateQueue
{
	[self setDelegate:newDelegate delegateQueue:newDelegateQueue synchronously:NO];
}

- (void)synchronouslySetDelegate:(id<BAASCGCDAsyncSocketDelegate>)newDelegate delegateQueue:(dispatch_queue_t)newDelegateQueue
{
...
- (BOOL)acceptOnInterface:(NSString *)inInterface port:(uint16_t)port error:(NSError **)errPtr
{
	...
	dispatch_block_t block = ^{ @autoreleasepool {
		...
		if (enableIPv4)
		{
			...
			__weak BAASCGCDAsyncSocket *weakSelf = self;
			
            dispatch_source_set_event_handler(self->accept4Source, ^{ @autoreleasepool {
			#pragma clang diagnostic push
			#pragma clang diagnostic warning "-Wimplicit-retain-self"
				
				__strong BAASCGCDAsyncSocket *strongSelf = weakSelf;
...
- (BOOL)doAccept:(int)parentSocketFD
{
	...
	if (delegateQueue)
	{
		__strong id<BAASCGCDAsyncSocketDelegate> theDelegate = delegate;
		...
		dispatch_async(delegateQueue, ^{ @autoreleasepool {
			...
			// Create BAASCGCDAsyncSocket instance for accepted socket
			
			BAASCGCDAsyncSocket *acceptedSocket = [[[self class] alloc] initWithDelegate:theDelegate
...
- (NSError *)badConfigError:(NSString *)errMsg
{
	...
	return [NSError errorWithDomain:BAASCGCDAsyncSocketErrorDomain code:BAASCGCDAsyncSocketBadConfigError userInfo:userInfo];
}
...
- (NSError *)badParamError:(NSString *)errMsg
{
	...
	return [NSError errorWithDomain:BAASCGCDAsyncSocketErrorDomain code:BAASCGCDAsyncSocketBadParamError userInfo:userInfo];
}
...
{
	NSString *errMsg = NSLocalizedStringWithDefaultValue(@"BAASCGCDAsyncSocketConnectTimeoutError",
	                                                     @"BAASCGCDAsyncSocket", [NSBundle mainBundle],
	                                                     @"Attempt to connect to host timed out", nil);
	
	NSDictionary *userInfo = @{NSLocalizedDescriptionKey : errMsg};
	
	return [NSError errorWithDomain:BAASCGCDAsyncSocketErrorDomain code:BAASCGCDAsyncSocketConnectTimeoutError userInfo:userInfo];
}
...
{
	NSString *errMsg = NSLocalizedStringWithDefaultValue(@"BAASCGCDAsyncSocketReadMaxedOutError",
														 @"BAASCGCDAsyncSocket", [NSBundle mainBundle],
														 @"Read operation reached set maximum length", nil);
	
	NSDictionary *info = @{NSLocalizedDescriptionKey : errMsg};
	
	return [NSError errorWithDomain:BAASCGCDAsyncSocketErrorDomain code:BAASCGCDAsyncSocketReadMaxedOutError userInfo:info];
}
...
{
	NSString *errMsg = NSLocalizedStringWithDefaultValue(@"BAASCGCDAsyncSocketReadTimeoutError",
	                                                     @"BAASCGCDAsyncSocket", [NSBundle mainBundle],
	                                                     @"Read operation timed out", nil);
	
	NSDictionary *userInfo = @{NSLocalizedDescriptionKey : errMsg};
	
	return [NSError errorWithDomain:BAASCGCDAsyncSocketErrorDomain code:BAASCGCDAsyncSocketReadTimeoutError userInfo:userInfo];
}
...
{
	NSString *errMsg = NSLocalizedStringWithDefaultValue(@"BAASCGCDAsyncSocketWriteTimeoutError",
	                                                     @"BAASCGCDAsyncSocket", [NSBundle mainBundle],
	                                                     @"Write operation timed out", nil);
	
	NSDictionary *userInfo = @{NSLocalizedDescriptionKey : errMsg};
	
	return [NSError errorWithDomain:BAASCGCDAsyncSocketErrorDomain code:BAASCGCDAsyncSocketWriteTimeoutError userInfo:userInfo];
}

- (NSError *)connectionClosedError
{
	NSString *errMsg = NSLocalizedStringWithDefaultValue(@"BAASCGCDAsyncSocketClosedError",
	                                                     @"BAASCGCDAsyncSocket", [NSBundle mainBundle],
	                                                     @"Socket closed by remote peer", nil);
	
	NSDictionary *userInfo = @{NSLocalizedDescriptionKey : errMsg};
	
	return [NSError errorWithDomain:BAASCGCDAsyncSocketErrorDomain code:BAASCGCDAsyncSocketClosedError userInfo:userInfo];
}
...
- (NSError *)otherError:(NSString *)errMsg
{
	...
	return [NSError errorWithDomain:BAASCGCDAsyncSocketErrorDomain code:BAASCGCDAsyncSocketOtherError userInfo:userInfo];
}
...
- (BOOL)usingCFStreamForTLS
{
	...
	{
		// The startTLS method was given the BAASCGCDAsyncSocketUseCFStreamForTLS flag.
                        ...
                        tag:(long)tag
{
	...
	BAASCGCDAsyncReadPacket *packet = [[BAASCGCDAsyncReadPacket alloc] initWithData:buffer
	                                                          startOffset:offset
	                                                            maxLength:length
	                                                              timeout:timeout
	                                                           readLength:0
...
- (float)progressOfReadReturningTag:(long *)tagPtr bytesDone:(NSUInteger *)donePtr total:(NSUInteger *)totalPtr
{
	...
	dispatch_block_t block = ^{
        ...
        if (!self->currentRead || ![self->currentRead isKindOfClass:[BAASCGCDAsyncReadPacket class]])
		{
...
- (void)maybeDequeueRead
{
	...
	if ((currentRead == nil) && (flags & kConnected))
	{
		if ([readQueue count] > 0)
		{
			...
			if ([currentRead isKindOfClass:[BAASCGCDAsyncSpecialPacket class]])
			{
				LogVerbose(@"Dequeued BAASCGCDAsyncSpecialPacket");
			...
			{
				LogVerbose(@"Dequeued BAASCGCDAsyncReadPacket");
...
- (void)doReadData
{
	...
	if ([self usingCFStreamForTLS])
	{
		...
		// Requested CFStream, rather than SecureTransport, for TLS (via BAASCGCDAsyncSocketUseCFStreamForTLS)
...
- (void)completeCurrentRead
{
	...
	{
		BAASCGCDAsyncReadPacket *theRead = currentRead; // Ensure currentRead retained since result may not own buffer
...
- (void)doReadTimeout
{
	...
	{
		BAASCGCDAsyncReadPacket *theRead = currentRead;
...
- (void)writeData:(NSData *)data withTimeout:(NSTimeInterval)timeout tag:(long)tag
{
	...
	BAASCGCDAsyncWritePacket *packet = [[BAASCGCDAsyncWritePacket alloc] initWithData:data timeout:timeout tag:tag];
...
- (float)progressOfWriteReturningTag:(long *)tagPtr bytesDone:(NSUInteger *)donePtr total:(NSUInteger *)totalPtr
{
	...
	dispatch_block_t block = ^{
        ...
        if (!self->currentWrite || ![self->currentWrite isKindOfClass:[BAASCGCDAsyncWritePacket class]])
		{
...
- (void)maybeDequeueWrite
{
	...
	if ((currentWrite == nil) && (flags & kConnected))
	{
		if ([writeQueue count] > 0)
		{
			...
			if ([currentWrite isKindOfClass:[BAASCGCDAsyncSpecialPacket class]])
			{
				LogVerbose(@"Dequeued BAASCGCDAsyncSpecialPacket");
			...
			{
				LogVerbose(@"Dequeued BAASCGCDAsyncWritePacket");
...
- (void)doWriteData
{
	...
	// Note: This method is not called if currentWrite is a BAASCGCDAsyncSpecialPacket (startTLS packet)
...
- (void)doWriteTimeout
{
	...
	{
		BAASCGCDAsyncWritePacket *theWrite = currentWrite;
...
- (void)startTLS:(NSDictionary *)tlsSettings
{
	...
	BAASCGCDAsyncSpecialPacket *packet = [[BAASCGCDAsyncSpecialPacket alloc] initWithTLSSettings:tlsSettings];
...
- (void)maybeStartTLS
{
	...
	if ((flags & kStartingReadTLS) && (flags & kStartingWriteTLS))
	{
		...
		#if TARGET_OS_IPHONE
		{
			BAASCGCDAsyncSpecialPacket *tlsPacket = (BAASCGCDAsyncSpecialPacket *)currentRead;
            NSDictionary *tlsSettings = @{};
            if (tlsPacket) {
                tlsSettings = tlsPacket->tlsSettings;
            }
			NSNumber *value = [tlsSettings objectForKey:BAASCGCDAsyncSocketUseCFStreamForTLS];
...
{
	BAASCGCDAsyncSocket *asyncSocket = (__bridge BAASCGCDAsyncSocket *)connection;
...
- (void)ssl_startTLS
{
	...
	NSNumber *shouldManuallyEvaluateTrust = [tlsSettings objectForKey:BAASCGCDAsyncSocketManuallyEvaluateTrust];
	...
	//  3. BAASCGCDAsyncSocketSSLPeerID
	//  4. BAASCGCDAsyncSocketSSLProtocolVersionMin
	//  5. BAASCGCDAsyncSocketSSLProtocolVersionMax
	//  6. BAASCGCDAsyncSocketSSLSessionOptionFalseStart
	//  7. BAASCGCDAsyncSocketSSLSessionOptionSendOneByteRecord
	//  8. BAASCGCDAsyncSocketSSLCipherSuites
	//  9. BAASCGCDAsyncSocketSSLDiffieHellmanParameters (Mac)
	//
	...
	value = [tlsSettings objectForKey:BAASCGCDAsyncSocketSSLPeerID];
	...
	{
		NSAssert(NO, @"Invalid value for BAASCGCDAsyncSocketSSLPeerID. Value must be of type NSData."
		             @" (You can convert strings to data using a method like"
		             @" [string dataUsingEncoding:NSUTF8StringEncoding])");
		
		[self closeWithError:[self otherError:@"Invalid value for BAASCGCDAsyncSocketSSLPeerID."]];
		return;
	}
	
	// 4. BAASCGCDAsyncSocketSSLProtocolVersionMin
	
	value = [tlsSettings objectForKey:BAASCGCDAsyncSocketSSLProtocolVersionMin];
	...
	{
		NSAssert(NO, @"Invalid value for BAASCGCDAsyncSocketSSLProtocolVersionMin. Value must be of type NSNumber.");
		
		[self closeWithError:[self otherError:@"Invalid value for BAASCGCDAsyncSocketSSLProtocolVersionMin."]];
		return;
	}
	
	// 5. BAASCGCDAsyncSocketSSLProtocolVersionMax
	
	value = [tlsSettings objectForKey:BAASCGCDAsyncSocketSSLProtocolVersionMax];
	if ([value isKindOfClass:[NSNumber class]])
	{
	...
	{
		NSAssert(NO, @"Invalid value for BAASCGCDAsyncSocketSSLProtocolVersionMax. Value must be of type NSNumber.");
		
		[self closeWithError:[self otherError:@"Invalid value for BAASCGCDAsyncSocketSSLProtocolVersionMax."]];
		return;
	}
	
	// 6. BAASCGCDAsyncSocketSSLSessionOptionFalseStart
	
	value = [tlsSettings objectForKey:BAASCGCDAsyncSocketSSLSessionOptionFalseStart];
	if ([value isKindOfClass:[NSNumber class]])
	{
	...
	{
		NSAssert(NO, @"Invalid value for BAASCGCDAsyncSocketSSLSessionOptionFalseStart. Value must be of type NSNumber.");
		
		[self closeWithError:[self otherError:@"Invalid value for BAASCGCDAsyncSocketSSLSessionOptionFalseStart."]];
		return;
	}
	
	// 7. BAASCGCDAsyncSocketSSLSessionOptionSendOneByteRecord
	
	value = [tlsSettings objectForKey:BAASCGCDAsyncSocketSSLSessionOptionSendOneByteRecord];
	if ([value isKindOfClass:[NSNumber class]])
	{
	...
	{
		NSAssert(NO, @"Invalid value for BAASCGCDAsyncSocketSSLSessionOptionSendOneByteRecord."
		             @" Value must be of type NSNumber.");
		
		[self closeWithError:[self otherError:@"Invalid value for BAASCGCDAsyncSocketSSLSessionOptionSendOneByteRecord."]];
		return;
	}
	
	// 8. BAASCGCDAsyncSocketSSLCipherSuites
	
	value = [tlsSettings objectForKey:BAASCGCDAsyncSocketSSLCipherSuites];
	if ([value isKindOfClass:[NSArray class]])
	{
	...
	{
		NSAssert(NO, @"Invalid value for BAASCGCDAsyncSocketSSLCipherSuites. Value must be of type NSArray.");
		
		[self closeWithError:[self otherError:@"Invalid value for BAASCGCDAsyncSocketSSLCipherSuites."]];
		return;
	}
	
	// 9. BAASCGCDAsyncSocketSSLDiffieHellmanParameters
	
	#if !TARGET_OS_IPHONE
	value = [tlsSettings objectForKey:BAASCGCDAsyncSocketSSLDiffieHellmanParameters];
	if ([value isKindOfClass:[NSData class]])
	{
	...
	{
		NSAssert(NO, @"Invalid value for BAASCGCDAsyncSocketSSLDiffieHellmanParameters. Value must be of type NSData.");
		
		[self closeWithError:[self otherError:@"Invalid value for BAASCGCDAsyncSocketSSLDiffieHellmanParameters."]];
		return;
	}
	#endif
	...
	if (value)
	{
		NSAssert(NO, @"Security option unavailable - kCFStreamSSLLevel"
		             @" - You must use BAASCGCDAsyncSocketSSLProtocolVersionMin & BAASCGCDAsyncSocketSSLProtocolVersionMax");
	...
	sslPreBuffer = [[BAASCGCDAsyncSocketPreBuffer alloc] initWithCapacity:(1024 * 4)];
...
- (void)ssl_continueSSLHandshake
{
	...
	else if (status == errSSLPeerAuthCompleted)
	{
		...
		else
		{
			...
			NSString *msg = @"BAASCGCDAsyncSocketManuallyEvaluateTrust specified in tlsSettings,"
...
- (void)cf_startTLS
{
	...
	NSAssert([currentRead isKindOfClass:[BAASCGCDAsyncSpecialPacket class]], @"Invalid read packet for startTLS");
	NSAssert([currentWrite isKindOfClass:[BAASCGCDAsyncSpecialPacket class]], @"Invalid write packet for startTLS");
...
+ (void)startCFStreamThreadIfNeeded
{
	...
	dispatch_once(&predicate, ^{
		...
		cfstreamThreadSetupQueue = dispatch_queue_create("BAASCGCDAsyncSocket-CFStreamThreadSetup", DISPATCH_QUEUE_SERIAL);
	});
...
{
	[[NSThread currentThread] setName:BAASCGCDAsyncSocketThreadName];
...
+ (void)scheduleCFStreams:(BAASCGCDAsyncSocket *)asyncSocket
{
	LogTrace();
...
+ (void)unscheduleCFStreams:(BAASCGCDAsyncSocket *)asyncSocket
{
	LogTrace();
	NSAssert([NSThread currentThread] == cfstreamThread, @"Invoked on wrong thread");
...
{
	BAASCGCDAsyncSocket *asyncSocket = (__bridge BAASCGCDAsyncSocket *)pInfo;
